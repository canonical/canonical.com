...
blog_views = BlogViews(
    ...
    excluded_tags=[
        # fmt: off
        # Exclude articles with Ubuntu specific tags
        3184, 3265, 3599, 1246, 4155, 2016, 2551, 4410, 4814, 4815,
        3335, 1364, 4195, 4464, 4468, 4063, 2562, 2195, 4229, 1374,
        3586, 4816, 4817, 1780, 1833, 1350, 4574, 1695, 1848, 1342,
        1774, 4378, 4818, 4697, 1295, 1920, 1610, 1626, 3332, 4540,
        4478, 4387, 4443, 2085, 1739, 4820, 4484, 4209, 1239, 1227,
        2558, 4488, 2669, 1672, 1567, 1639, 1941, 4183, 3888, 2567,
        4687, 1296, 3506
        # fmt: on
    ],
    per_page=11,
