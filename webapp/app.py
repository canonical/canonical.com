...
from webapp.llms import build_llms_view
...
# LLM-friendly site indexes (https://llmstxt.org/). Served from disk and
# regenerated by an authenticated POST, mirroring /sitemap_tree.xml.
app.add_url_rule(
    "/llms.txt",
    endpoint="llms_txt",
    view_func=build_llms_view(app, "llms.txt"),
    methods=["GET", "POST"],
)
app.add_url_rule(
    "/llms-full.txt",
    endpoint="llms_full_txt",
    view_func=build_llms_view(app, "llms-full.txt"),
    methods=["GET", "POST"],
)
